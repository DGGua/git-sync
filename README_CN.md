...
3. **添加 SSH 密钥** - 在 Keys 页面生成或导入密钥

4. **配置公钥** - 将公钥添加到 Git 托管服务（GitHub/GitLab/Gitea 等）

5. **添加仓库** - 在 Repositories 页面配置源和目标仓库

6. **启用自动同步** - 每个仓库可单独配置同步间隔
